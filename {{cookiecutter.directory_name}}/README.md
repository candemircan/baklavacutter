...
├── docs # documentation, rendered to {{cookiecutter.user_name}}.github.io/{{cookiecutter.user_name}}
...
*Another Note*: None of the content in the `data` and `results` folders are committed to the repository. Once the project is finalised, I'll share them on OSF.